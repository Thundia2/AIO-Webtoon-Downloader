...
**AIO-merged integration:**
- Continued the original zzyil changelog history and recorded the `AIO-merged` codebase integration as a new entry instead of replacing the existing release notes.
